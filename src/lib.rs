        ...
        for row in 0..self.height {
            for col in 0..self.width {
                ...
                let next_cell = match (cell, live_neighbours) {
                    ...
                    // Rule 3: Any live cell with more than three live neighbours dies, as if caused by overpopulation.
                    (Cell::Alive, x) if x > 3 => Cell::Dead,
                    // Rule 4: Any dead cell with exactly three live neightbours becomes a live cell, as if by reproduction.
